...
class NoteController extends CommonController {
    ...
    public function crowd_list(){
        ...
        foreach ($crowdlist as $key=>$crowd){
            ...
            $notecount = $notemodel->findone('note_type = 1 and note_cid = '.$crowd['crowd_id'],'count(*) num')['num'];
    ...
    public function note_list(){
        ...
        if (isset($_POST['button'])){
            ...
            if (isset($_GET['p'])) {
                ...
                $_SESSION['note_note_list_where'] = 'note_type=1';
    ...
    public function ajax_note_list_hide(){
        ...
        if (IS_POST) {
            ...
            try {
                ...
                $userres = $usermodel->updataone('user_id = '.$noteone['note_uid'],$userdata);
