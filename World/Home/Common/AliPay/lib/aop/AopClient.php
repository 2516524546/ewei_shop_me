...
';
	...
	public function alonersaSign($data,$privatekey,$signType = "RSA",$keyfromfile=false) {
		...
		// echo $sign;exit;
		//这里$sign  无法生成，说明openssl_sign 函数没有生效
		if($keyfromfile){
			openssl_free_key($res);
		}
		$sign = base64_encode($sign);
