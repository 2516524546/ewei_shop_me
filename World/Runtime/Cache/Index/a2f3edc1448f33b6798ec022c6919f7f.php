...
<html lang="en">
        <head>
                <meta charset="UTF-8">
                <title>Virtual Currency Recharge</title>
                ...
                <link rel="stylesheet" href="../web/css/success_index.css">
                <link rel="stylesheet" href="../web/css/VCR.css">
            </head>
            <body>
                <!-- logo -->
                ...
                <div class="container crumbs">
                    <a href="index.html" class="crumbsa"><img src="../web/img/common_dh_icon_home.png" alt=""></a>
                    <cite class="Icon"></cite>
                    <span class="crumbsTitle">Virtual Currency Recharge</span>
                </div>
                    ...
                    <div class="StepContainerOne">
                        <div class="FormContainer" pane>
                            <label class="layui-form-label label-spacing">
                                <span class="mailbox-icon8"></span>
                            </label>
                            <div class="layui-input-block input-spacing">
                                <input type="text" name="number" lay-verify="required" autocomplete="off" placeholder="Input verification code" class="layui-input">
                            </div>
                        </div>
                        <div class="FormContainer" pane>
                            <label class="layui-form-label label-spacing">
                                <span class="mailbox-icon9"></span>
                            </label>
                            <div class="layui-input-block input-spacing">
                        ...
                        <div class="FormContainer" pane>
                            ...
                            <div class="layui-input-block input-spacing code_password">
                                <input type="password" name="password" lay-verify="required" autocomplete="off" placeholder="Input verification code" class="layui-input inputWidth">
                                <div class="code_img"><img src="../web/img/01_shouye/VerificationCode.png" alt="" id="img"></div>
                                <span class="code_change">Can not see,schange one!</span>
                            </div>
                        </div>
    ...
    <footer class="container-fluid FooterBg">
        ...
        <!-- foot end 底部信息 -->
            ...
            <!-- <script>
            $(".code_password .code_change").on("click",function(){
