...
<head>
    ...
    <link rel="stylesheet" href="/Public/Web/web/css/Interest.css">
                ...
                <div class="nav">
                    <nav class="navbar NavBg">
                        <ul class="ListInline">
                            ...
                            <li><a href="<?php echo U('Index/Rnterst/interest');?>" id="NavSelected">Interst</a></li>
            ...
            <div class="row">
                <div class="col-md-4">
                    <?php if(is_array($data)): foreach($data as $firstkey=>$first): ?><div class="SelectionTypeContainer"  id="first<?php echo ($first['first_mark_id']); ?>">
                        <label class="layui-form-label">
                            <span><img src="/Public/Web/web/img/02_interest/interest_create_icon_0<?php echo ($firstkey+1); ?>.png"></span>
                        </label>
                ...
                <div class="col-md-6">
                    <div class="SelectionContainer">
                        ...
                        <a href="javascript:void(0)" id="SelectionIcon" onclick="updata_interest_list(2,'crowd_creattime',0,10,1)"><img src="/Public/Web/web/img/02_interest/interest_qxx_search_icon.png"></a>
                    </div>
                </div>
                <div class="col-md-2">
...
<script>
    ...
    function gocreate() {
        ...
        if(aa){
            window.location.href="<?php echo U('Index/Rnterst/createInterest');?>";
        }else{
            layer.msg("请先登录",{
                    time:1500,
                },function(){
    ...
    //mid:模块id，order：排序字段，limit1：从第几条开始，limit2，得到多少条
    //type：1为修改，2为新增
                ...
                if(list!=null&&list!=""){
                    ...
                    if (list.str == 1){
                        ...
                        for (var i = 0; i < list.msg.length; i++) {
                            ...
                            var url="<?php echo U('Index/Rnterst/groupDetails');?>&cid="+list.msg[i].crowd_id;
    ...
    $(window).scroll(function () {
        ...
        if (gocheng>(scrollHeight-200)) {
            if (c==a){
                ...
                c = 2;
                if (limit1<count){
                    updata_interest_list(2,'crowd_creattime desc',limit1,10,2);
                    page += 1;
                }
            }
        }
