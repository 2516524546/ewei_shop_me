...
<body>
    ...
    <div class="container Crumbs">
        ...
        <span class="CrumbsTitles">Q & A details</span>
        </span>
    </div>
    <div class="container StickSonDetailsContainer">
        <div class="row">
            <div class="col-md-9">
                <!-- <p class="text-right"><a href="#"><img src="img/02_interest/fenxiang.png"></a></p> -->
                        ...
                        <div class="box">
                            ...
                            <div class="GuestBookContainer">
                                <div class="GuestBookUserTitleContainer">
                                    ...
                                    <img src="/Public/Web/web/img/02_interest/interest_xq_icon_great.png">
            ...
            <div class="col-md-3">
                <div class="GroupDetailsContainer">
                    ...
                    <p class="p"><b>Post Information</b></p>
                    <p class="p"><b>Reward  :</b>111 virtual currency</p>
