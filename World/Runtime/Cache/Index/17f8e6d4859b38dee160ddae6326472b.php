...
<head>
    ...
    <link rel="stylesheet" href="/Public/Web/web/css/PostVideoDetails.css">
...
<body>
    ...
    <div class="container Crumbs">
        <span class="CrumbsSpan">
          <a href="<?php echo U('Index/Jobs/work');?>" class="CrumbsA">Interest</a>
    ...
    <div class="container StickSonDetailsContainer">
        <div class="row">
            <div class="col-md-9">
                <p class="text-right">
                    <a href="<?php echo U('Index/Jobs/postSharing');?>">
                ...
                <div class="StickSonDetailsContent">
                    ...
                    <p>
                        <div class="picfenxiangbox">
                            <a href="<?php echo U('Index/Jobs/videoFen');?>">
                                <img src="/Public/Web/web/img/02_interest/picfenxiang.png" class="picfenxiang">
                            </a>
                        </div>
