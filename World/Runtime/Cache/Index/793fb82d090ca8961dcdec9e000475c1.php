...
<head>
    ...
    <link rel="stylesheet" href="/Public/Web/web/css/PostProduct.css">
</head>
...
<?php if(!$userid): ?><div class="logreg">
    ...
    <div class="container crumbs">
            ...
            <cite class="Icon"></cite>
            <span class="crumbsTitle">Post Product</span>
    </div>
        ...
        <div class="PasswordContainer">
            <div class="StepContainer">
                <div class="StepContainerOne">
                    ...
                    <?php if(is_array($data)): foreach($data as $firstkey=>$first): if($firstkey==2||$firstkey==3||$firstkey==4): ?><div id="first<?php echo ($first['first_mark_id']); ?>" class="FormContainer" pane>
                        <label class="layui-form-label label-spacing">
                            <span class="<?php if($firstkey == 2): ?>CountryIcon<?php elseif($firstkey == 3): ?>SchoolIcon<?php elseif($firstkey == 4): ?>InterestIcon<?php endif; ?>"></span>
                        </label>
                        <div class="layui-input-block" id="layui-input-block">
                            ...
                            <select name="second" lay-verify="required" lay-filter="firstselect">
                                <option value="" selected="selected"><?php if($firstkey == 2): ?>Choose a state<?php elseif($firstkey == 3): ?>Choose a ctiy<?php elseif($firstkey == 4): ?>Choose a university<?php endif; ?></option>
                    ...
                    <div class="FormContainer" pane>
                            <label class="layui-form-label label-spacing">
                                <span class="GroupProductNameIcon"></span>
                            </label>
                            <div class="layui-input-block input-spacing">
                                <input type="text" name="number" id="name" lay-verify="required" autocomplete="off" placeholder="Enter the product name" class="layui-input">
                            </div>
                    </div>
                    <div class="FormContainer" pane>
                            <label class="layui-form-label label-spacing">
                                <span class="GroupProductPriceIcon"></span>
                            </label>
                            <div class="layui-input-block input-spacing">
                                <input type="text" name="number" id="price" lay-verify="required" autocomplete="off" placeholder="Enter the product price" class="layui-input">
                            </div>
                    </div>
                    <div class="FormContainer" pane>
                            <label class="layui-form-label label-spacing">
                            ...
                            <div class="layui-input-block input-spacing">
                                <input type="text" name="number" id="uname" lay-verify="required" autocomplete="off" placeholder="Contact name" class="layui-input">
                            </div>
                    </div>
                    <div class="FormContainer" pane>
                                <label class="layui-form-label label-spacing">
                                    <span class="GroupContactNumber"></span>
                                </label>
                                <div class="layui-input-block input-spacing">
                                    <input type="text" name="number" id="contact" lay-verify="required" autocomplete="off" placeholder="Enter the contact number / email address" class="layui-input">
                                </div>
                    </div>
                    <?php if(is_array($data)): foreach($data as $firstkey=>$first): if($firstkey==0): ?><div id="first<?php echo ($first['first_mark_id']); ?>" class="FormContainer" pane>
                                <label class="layui-form-label label-spacing">
                                ...
                                <div class="layui-input-block" id="layui-input-block">
                                    ...
                                    <input type="hidden" value="" id="in<?php echo ($first['first_mark_id']); ?>">
                                    <select name="second" id="category" lay-verify="required" lay-filter="firstselect">
                                        <option value="" selected="selected">Choose a static</option>
                                        <?php if(is_array($first['message'])): foreach($first['message'] as $secondkey=>$second): ?><option value="<?php echo ($second['second_mark_id']); ?>"><?php echo ($second['second_mark_name']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                            </div><?php endif; endforeach; endif; ?>
                    ...
                    <div class="FormContainer" pane>
                        ...
                        <div class="layui-input-block input-spacing">
                            <input type="text" name="number" id="content" lay-verify="required" autocomplete="off" placeholder="Enter the product description" class="layui-input">
                        </div>
                    </div>
                    <div class="FormContainer" pane>
                    ...
                    <div class="FormContainer" pane>
                            ...
                            <div class="layui-input-block input-spacing">
                                <input type="text" name="number" id="explain" lay-verify="required" autocomplete="off" placeholder="Enter the product comment" class="layui-input">
                            </div>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.str == 1) {
                            $.ajax({
                                type: "post",
                                url: "<?php echo U('Index/Ajax/ajax_postProduct');?>",
                                data: {
                                    second: second,
                                    third: third,
                                    four: four,
                                ...
                                success: function (product) {
                                    ...
                                    if (product.str == 1) {
                                        layer.msg('发布成功', {
                                                ...
                                                window.location.href = "<?php echo U('Index/Life/lifeProductDetails');?>&cid=" + product.msg;
                                            }
                                        );

                                    } else {
                                        layer.msg(product.msg, {
                                                time: 1500,
                                                icon: 2,
                                            }
                                        );
