...
<body>
    ...
    <div class="container crumbs">
        ...
        <span class="crumbsTitle">Job Listings</span>
    </div>
    <div class="container">
        <div class="butbox">
            <a href="<?php echo U('Index/Jobs/releasePosition');?>" class="layui-btn layui-btn-normal layui-btn-radius fontcss">Post a job</a>
            <a href="<?php echo U('Index/Jobs/releaseMyPosition');?>" class="layui-btn layui-btn-normal layui-btn-radius fontcss">My post</a>
            <a href="<?php echo U('Index/User/resumeDetails');?>&gourl=0" class="layui-btn layui-btn-normal layui-btn-radius fontcss">View my resume</a>
        </div>
        <div class="frombox">
            ...
            <div class="SelectionTypeContainer">
                ...
                <div class="fromboxxiala">
                    <input type="text" name="title" required  lay-verify="required" placeholder="Enter position" autocomplete="off">
                </div>
            </div>
        </div>
    </div>
    <div class="container ContributionContainer">
        <div class="row">
            <div class="col-md-6">
                <div class="UserBox">
                    <a href="<?php echo U('Index/Jobs/jobdetails');?>" class="UserLink">
                        <p class="lintpheight">
                        ...
                        <p class="lintpheight">
                            Salary :   $ 1000 ~ $ 2000
                            <span class="picon">
                                <img src="/Public/Web/web/img/04_jobs/jobs_zwlb_icon_zj.png">
                                1280
                            </span>
                        </p>
                    </a>
