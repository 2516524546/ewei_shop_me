                                    ...
                                    <table class="layui-table PostTable" lay-skin="line">
                                        <tbody id="postcontent">
                                            <?php if(is_array($notelist)): foreach($notelist as $notekey=>$note): ?><tr>
                                                <td>
                                                    <a href="<?php echo U('Index/Rnterst/stickSonDetails');?>&cid=<?php echo ($cid); ?>&nid=<?php echo ($note['note_id']); ?>" style="text-decoration: none;">
            ...
            <div class="col-md-4">
                ...
                <div class="GroupDetailsContainer">
                    ...
                    <?php if($join_in != 1): ?><p class="text-center Followtbut">
                        <a href="javascript:void(0)" class="layui-btn layui-btn-radius layui-btn-lg layui-btn-normal" id="GroupBtn" onclick="follow()">
                        Follow
                        </a>
                    </p><?php endif; ?>
                </div>
...
<script>
    ...
    function follow() {
        ...
        if(aa){
            ...
            $.ajax({
                type:"post",
                url:"<?php echo U('Index/Ajax/ajax_followcrowd');?>",
                data:{
                    cid:cid,
                },
                dataType:"json",
                ...
                if(list!=null&&list!=""){
                    ...
                    if (list.str == 1){
                        ...
                        for (var i = 0; i < list.msg.length; i++) {
                            ...
                            message += '</span></a></td><td class="NameBox">'
                            message += '<a href="'+url+'" style="text-decoration: none;">';
                            message += list.msg[i].question_name
                            message += '</a></td><td class="NameIcom">'
