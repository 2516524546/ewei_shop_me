...
<div class="row" style="padding-bottom: 10px;">
							...
							<style type='text/css'>
								...
								<div class='anniu'>
									<ul>
										...
										<li onClick="my_pwd()" class="current">修改密码</li>
	...
	<div class="row">
		<div class="col-xs-12">
			<form class="form-horizontal" action="<?php echo U('Admin/User/up_mypwd');?>" method="POST" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" name="pwd" value="" placeholder="原密码" />
						</div>
					</div>
					...
					<div class="form-group">
					 ...
					 <div class="form-group" >
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1">密码重复</label>
						<div class="col-sm-9">
							<input type="password" name="passwordagain" value="" placeholder="重新再输入一次" />
						</div>
			     	</div>
