		...
		<div class="col-xs-12">
			 ...
			 <div class="row" style="padding-bottom: 10px;">
							<div class="col-sm-12">
								...
								<!-- 	<form class="form-horizontal" action="<?php echo U('Admin/Fenxiao/fenxiao_list_sou');?>" method="POST" role="form" enctype="multipart/form-data">
	...
	<!-- 
					 ...
					 -->
							...
							<!--	<div style=' width:100%; height:40px; '>
								   <a href="<?php echo U('Admin/Conf/admin_add');?>" target="rightFrame"><span style=' width:100px; height:34px; background:#2679b5; color:#fff; margin-right:10px; display:inline-block; line-height:34px;text-align:center; borde-radius:4px;'>添加管理员</span></a>
...
<form class="form-horizontal" id='admin_add' action="<?php echo U('Admin/Conf/admin_add');?>" method="POST" role="form" enctype="multipart/form-data">
<!-- 模拟框Modal 添加 -->
                        ...
                        <div class="col-sm-8">
                            <table id="add-table" class="table table-bordered" style="margin-bottom: 0px;font-size:13px;">
                                ...
                                <?php foreach($menus as $val){?>
                                    ...
                                    <tr>
                                        <td><img src="/Public/Admin/admin/images/images/u6376.png"><?php echo $val['m_name']?></td>
                                        <td><?php ?></td>
                                    </tr>
                                    <?php foreach($val['child'] as $v){?>	
	                                    <tr>
	                                        <td><img style="margin-left: 10px;" src="/Public/Admin/admin/images/images/u6380.png"><?php echo $v['m_name']?></td>
