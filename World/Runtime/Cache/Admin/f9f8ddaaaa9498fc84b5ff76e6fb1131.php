			 ...
			 <div class="row" style="padding-bottom: 10px;">
							<div class="col-sm-12">
								<div id="sample-table-2_filter">
									<form class="form-horizontal" action="<?php echo U('Admin/Jinxiao/fenxiao_list_sou');?>" method="POST" role="form" enctype="multipart/form-data">
									...
									<?php if($jinxiao){?>
										...
										<div class="btn-group" style='margin-top:5px;'>
												<span>所属代理商：</span>
												<select name="jxid" style="width:130px;">
													<option value="">全部</option>
													<?php foreach($jinxiao as $v){?>
													  <option value="<?php echo $v['jxid']?>" 
														  <?php if($jxid == $v['jxid']){echo 'selected';}?> >
														  <?php echo $v['jx_name'];?>
													  </option>
													<?php }?>
												</select>
			  ...
			  <script type="text/javascript" src="/Public/Admin/admin/js/region_select.js"></script>
							...
							<style type='text/css'>
								...
								<div class='anniu'>
								   ...
								   <a href="<?php echo U('Admin/Jinxiao/fx_daochu');?>" target="rightFrame"><span style=' width:100px; height:34px; background:#87b87f; color:#fff; margin-right:10px; display:inline-block; line-height:34px;text-align:center; borde-radius:4px;position:absolute; top:0; right:130px;' id='daochu'>导出excel</span></a>
	
								    <a href="<?php echo U('Admin/Jinxiao/fenxiao_add');?>" target="rightFrame"><span style=' width:100px; height:34px; background:#2679b5; color:#fff; margin-right:10px; display:inline-block; line-height:34px;text-align:center; borde-radius:4px;'>添加分销商</span></a>
					...
					<div class="table-responsive">
						<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="margin-bottom: 0px;font-size:13px;">
							...
							<?php foreach($list as $k=>$v){?>
								...
								<!-- 	<td><img src="<?php echo $v['jx_img']?>"></td> -->
									<td>
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											<a href="index.php?m=Admin&c=Jinxiao&a=fenxiao_xiang&jxid=<?php echo $v['jxid']?>" class="btn btn-xs btn-success" style="margin-top:5px;">详情</a>	
										    <a href="index.php?m=Admin&c=Jinxiao&a=fenxiao_edit&jxid=<?php echo $v['jxid']?>" class="btn btn-xs btn-success" style="margin-top:5px;">编辑</a>	
...
$(function(){
	...
	$(".xuan_songs").change(function(){
		...
		$.ajax({
			...
			data:'jxid='+jxid+'&catid='+catid+'&type=2',
			type:'post',
